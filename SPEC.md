...
- Each qualified Pi, Claude, or Devin launch receives one generated run UUID and one run-owned path under the endpoint-private Herdr Tools state namespace. Callers cannot select the path. AGY remains `AGY_UNQUALIFIED`.
