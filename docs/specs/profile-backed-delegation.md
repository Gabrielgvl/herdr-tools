...
- Typed call overrides may replace typed defaults, including capability-expanding Claude permission modes. Project profiles have no trust gate except that the two reserved promoter names cannot replace bundled profiles. These are deliberate trust choices.
