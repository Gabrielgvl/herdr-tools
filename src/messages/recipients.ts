...
export class RecipientRegistry {
  ...
  recordFor(operatingPointId: string, paneId: string, recipientKey: string, capability: AttachmentCapability & { kind: ProfileKind }, identity: PromptTargetIdentity & { agentId?: string }, evidence: RecipientRegistrationEvidence = {}): RecipientRecord {
